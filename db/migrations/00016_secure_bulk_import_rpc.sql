-- Migration 00016: Secure import_items_bulk_tx function
-- This ensures only authenticated admin or staff users can call the bulk import function, preventing unauthorized writes.
